...
Feature: New Menu
    ...
    Scenario: New Sheet, new Menu from previous sheet and add 2 Content libre. save one and coninue with the second content
        ...
        Then I should see "Ajouter un contenu avec le même affichage"
        Then I should see "Ajouter un contenu avec un affichage différent"
    ...
    Scenario: I can update a menu
        ...
        Then I should see "Sauvegarder"
        Then I should see "HERMES HERMES"
        Then I should not see "Ajouter un contenu avec le même affichage"
        Then I should not see "Ajouter un contenu avec un affichage différent"
